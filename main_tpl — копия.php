		...
		<header>
			...
			<nav>
				<ul id="menu">
					...
					<li><a href="<?= SiteRoot("Projects")?>">Projects</a></li>
					<li><a href="<?= SiteRoot("Contacts")?>">Contacts</a></li>
					<li class="bg_none"><a href="<?= SiteRoot("Sitemap")?>">SiteMap</a></li>
				</ul>
			</nav>
			<div class="wrapper">
...
<!-- footer -->
	<footer>
		...
		<div class="wrapper font_size">
			<div class="pad">
				<p>Consulting.com &copy; 2015</p>
<p><u><a href="http://partners-pro.ru" target="_blank">Partners-Pro.ru</a></u>&nbsp;| Бесплатное изготовление сайтов</p>
			</div>
		</div>
	</footer>
<!-- / footer -->
