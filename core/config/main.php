<?php
    ...
    $g_config['phpIni']  = array
                            (
                                'error_reporting'    => false,  // Выдавать все ошибки за исключением нотайсов об устаревшом коде
                                'display_errors'     => off,            // Выводить ли ошибки в браузер
